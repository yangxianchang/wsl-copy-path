...
reg delete "HKEY_CURRENT_USER\Software\Classes\*\shell\CopyWslPath"              /f 2>$null
reg delete "HKEY_CURRENT_USER\Software\Classes\Directory\shell\CopyWslPath"      /f 2>$null
reg delete "HKEY_CURRENT_USER\Software\Classes\Directory\Background\shell\CopyWslPath" /f 2>$null
